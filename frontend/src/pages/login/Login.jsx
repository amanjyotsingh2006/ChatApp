        ...
        <div className='flex flex-col items-center justify-center mx-auto min-w-96'>
            <div className="w-full max-w-md p-6 rounded-lg shadow-md bg-white/10 backdrop-blur-lg border border-white/20">
                ...
                <form>
                    ...
                    <div className='ml-2'>
                        <a href="/signup/SignUp.jsx" className='text-sm hover:text-blue-500 mt-2'>Don't Have an account?</a>
                    </div>
                    <div className='p-2 flex text-center justify-center'>
                        <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl w-full h-8 text-lg hover:bg-blue-500 hover:border-white active:border-white">Login</button>
                    </div>
                </form>
            </div>
        </div>
